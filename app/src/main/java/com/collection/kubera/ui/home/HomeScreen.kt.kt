        ...
        ModalNavigationDrawer(
            ...
            drawerContent = {
                Column(
                    ...
                    Text(text = "Menu Item 1", modifier = Modifier.clickable { /* Handle click */ })
                    Spacer(modifier = Modifier.height(8.dp))
                    Text(text = "Menu Item 2", modifier = Modifier.clickable { /* Handle click */ })
                    Spacer(modifier = Modifier.height(8.dp))
                    Text(text = "Menu Item 3", modifier = Modifier.clickable { /* Handle click */ })
                }
            },
            content = {
                Scaffold(topBar = {
